(function($){
    ...
    */
    ...
    function initContactForm (argument) {
        $("#contact").submit(function (e) {
            ...
            var dataString = 'csrfmiddlewaretoken=' + csrf + '&name=' + name + '&email=' + email + '&subject=' + subject + '&message=' + message;
    ...
    function initGoogleMaps() {
            ...
            var mapOptions = {
                ...
                center: new google.maps.LatLng(26.545954, 88.7015349), //jgec
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(26.545954, 88.7015349),
                map: map,
                title: 'Find us here!'
            });
        }
    ...
    */
    ...
    function initSubmitIdeas(argument) {
        $("#submit_ideas").submit(function (e) {
            e.preventDefault();
            var data1 = $("#submit_ideas").serialize();
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        $("#submit_ideas")[0].reset();
                        $("#close_modal").click();
                        alert("Thank you for your submission, our reviewers will review and get back to you soon!");
                    }
                });
